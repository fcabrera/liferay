...
set "JAVA_OPTS=-Djboss.modules.system.pkgs=org.jboss.byteman"
...
set "JAVA_OPTS=%JAVA_OPTS% -Xmx1024m -XX:MaxMetaspaceSize=512m -XX:MetaspaceSize=200m -Djboss.as.management.blocking.timeout=480"
set "JAVA_OPTS=%JAVA_OPTS% -Dfile.encoding=UTF-8 -Djava.net.preferIPv4Stack=true -Duser.timezone=Mexico/General"
set "JAVA_OPTS=%JAVA_OPTS% -Dwildfly.home.dir=C:/liferay-portal-6.2.5/wildfly-10.1.0.Final"
set "JAVA_OPTS=%JAVA_OPTS% -Dsecmgr -Djava.security.policy=C:/liferay-portal-6.2.5/wildfly-10.1.0.Final/bin/server.policy"
set "JAVA_OPTS=%JAVA_OPTS% -Djava.io.tmpdir=C:/liferay-portal-6.2.5/wildfly-10.1.0.Final/standalone/tmp"
set "JAVA_OPTS=%JAVA_OPTS% -Dindra.es.configuracionExterna=C:/esapi/"
